...
const EpicHackathonAbout = () => {
  ...
  const aboutSections = [
    ...
    },
    {
      ...
      description: "24 hours of pure innovation energy",
      icon: "⚛️",
      color: "#0ea5e9", 
      content: "This 24-hour sprint is loaded with everything you'd want in a power-packed hackathon - from tech quiz battles to enhancement rounds."
    },
    {
    ...
    },
    {
      ...
      description: "Come with an idea. Leave with a legacy.",
      icon: "🔮",
      color: "#06b6d4",
      content: "It's more than an event. It's 24 hours of code, chaos, creativity, and community. The best part? You're not alone - mentors will guide you every step."
    }
  ];
    ...
    const runTerminal = () => {
      if (commandIndex < terminalCommands.length) {
        ...
        typeCommandFn(command, () => {
          ...
          setCurrentCommand('');
          commandIndex++;
          terminalInterval = setTimeout(runTerminal, 1500);
        });
      } else {
        setTimeout(() => {
          setTerminalLines([]);
      ...
      <div className="relative z-10 flex flex-col items-center justify-start min-h-screen text-center px-4 sm:px-6 py-8">
        ...
        <div className={`max-w-6xl mx-auto mb-16 transition-all duration-2000 delay-600 ${
          ...
          >
            ...
            Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-500 font-semibold">Hack Innovate</span> – where 
